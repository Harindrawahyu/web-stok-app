                        ...
                        <form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="name"
                                    ...
                                    tabindex="1" placeholder="Masukan nama lengkap.." value="{{ old('na,e') }}"
                                    required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email"
                                    ...
                                    tabindex="1" placeholder="Masukan alamat email.." value="{{ old('email') }}"
                                    required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input id="password_confirmation" type="password"
                                    ...
                                    name="password_confirmation" tabindex="2" placeholder="Konfirmasi kata sandi.."
                                    required>
                                <div class="invalid-feedback">
                                    Password tidak sama!
                                </div>
